...
-- Report API latency indexes (2026-09-13) live in 002-indexes.sql.
...
COMMENT ON COLUMN scanner_results.entry_quality_score IS 'Entry Quality v2 0-100 (code/entryQuality.js, 2026-09-14): is TODAY a good entry, separate from how good the setup is. EGX: extension vs EMA20 in ATR 30 (more extended = more pts, measured), relative volume 20, RSI 3-session slope 20, close position 15, SMC zone 15. US: relative volume only (15/50/85). Display-only; not a ranking factor.';
